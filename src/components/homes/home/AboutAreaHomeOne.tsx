...
A paixão pelo universo tech começou cedo nos jogos online, onde me destaquei e tive contato com diversos paises e culturas digitalmente.
  ...
  <br/><br/>Minha trajetória inclui passagens pela Nestlé, ZOOMtecnologia, Grupo Rumo.On e Secretaria do Estado de SC. Sou formado em Design com MBA em Estratégia e Design de UX pela FIAP. <br/><br/>Como destaque, participei da concepção e/ou melhoria contínua de produtos inovadores de IA em diferentes mercados: dados, energia renovável, saúde, contábil e telemarketing. </>,
  counter_data: [
    {
      id: 1,
      count: 10,
