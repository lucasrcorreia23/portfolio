...
import portfolio_img_4 from "@/assets/img/portfolio/zoomtech-secondimage.jpg";
import portfolio_img_3 from "@/assets/img/portfolio/zoomtech-prototypethreeimage.jpg";
import portfolio_img_2 from "@/assets/img/portfolio/zoomtech-prototypetwoimage.jpg";
import portfolio_img_1 from "@/assets/img/portfolio/zoomtech-prototypeimage.jpg";
...
const portfolio_detaisl_content: DataType = {
  title: "Em reuniões diretas com o CEO, alinhei expectativas, requisitos e restrições para organizar o esquema de cores e estratégia de naming da nova arquitetura de marca da companhia. Em seguida, embarquei nas 5 Forças de Porter para nortear meu fluxo de tarefas e realização de pesquisas, seguido de documentação e agrupamento das principais informações de forma a todo o time de marketing e criação conseguir encontrar e utiliza-las. Com todos os dados organizados, iniciei o processo de desenvolver Manual de Marca, Identidade Visual e prototipagem de cada página do site conforme modelo mental dos usuários e necessidades do time comercial, com reporte mensal ao CEO sobre a evolução do projeto.",
  features: [
...
const { title, counter_data, images } = portfolio_detaisl_content
              ...
              <div className="row">
                <div className="col-xl-5 col-lg-4">
                  <div className="porfolio-details__overview-left">
                    <h4 className="porfolio-details__overview-title mb-40">Resumo / <br/>Processo de Design</h4>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-xl-5 col-lg-4">
                  <div className="porfolio-details__result-left">
                    <h4 className="porfolio-details__overview-title mb-40">Resultados</h4>
                  </div>
                </div>
                <div className="col-xl-7 col-lg-8">
